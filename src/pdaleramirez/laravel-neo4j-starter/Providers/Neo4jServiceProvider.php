<?php namespace pdaleramirez\LaravelNeo4jStarter\Providers;

use pdaleramirez\LaravelNeo4jStarter\Passwords\PasswordBrokerManager;
...
class Neo4jServiceProvider extends ServiceProvider {
	...
	public function boot()
	{
		...
		{
			$model = $config['model'];
			return new \pdaleramirez\LaravelNeo4jStarter\Extensions\Neo4jAuthProvider($app['hash'], $model);
		});
		...
		\Session::extend('neo4jsession', function($app) {
			...
			return new \pdaleramirez\LaravelNeo4jStarter\Extensions\Neo4jSessionHandler($lifetime, $app);
		});
	...
	public function register()
	{
		...
		$this->app->bind("neo4jQuery", function() {
			return new \pdaleramirez\LaravelNeo4jStarter\Services\Neo4jQueryService();
		});

		// Extend the unique validation
		$this->app->bind("neo4jPresence", function() {
			return new \pdaleramirez\LaravelNeo4jStarter\Extensions\Neo4jPresenceVerifier;
		});
